...
echo ""
echo "Crypto environment (see .env.example for generation instructions):"
echo "   export ZDS_C2_CERT_FINGERPRINT=<sha256-hex-of-c2-cert>"
echo "   export ZDS_PLUGIN_SALT=<32-byte-hex-salt>"
echo "   export ZDS_PLUGIN_PUBKEY=<base64-ed25519-pubkey>"
echo "   export ZDS_PLUGIN_SIGNING_KEY=<base64-ed25519-privkey>"
echo ""
echo "Then run:"
